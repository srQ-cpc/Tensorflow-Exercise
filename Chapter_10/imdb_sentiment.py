...
def data_pad_sequences(data):
    data["X_train"] = pad_sequences(data["X_train"])
    data["sequence_length"] = data["X_train"].shape[1]
    data["X_test"] = pad_sequences(data["X_test"], maxlen=data["sequence_length"])
    return data
